...
WRS_CODE="bpbd_provpa"
LAT="-2.5869" #update to the latest one
LONG="140.68756" #update to the latest one
REMARK="BPBD Provinsi Papua"
#-2.5869430945064322, 140.68755727672658
# --- 1. Get Dynamic Date ---
